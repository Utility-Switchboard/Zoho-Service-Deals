...
class SDKInitializer(object):
    ...
    def initialize():
        ...
        user = UserSignature(email='jesus.sicairos-lopez@utilityswitchboard.com')
        ...
        """
        token = OAuthToken(client_id='1000.HAAD82BRZY9BJTTNEFZXLICAQ2XURX', client_secret='da75a833526ee10b96850069fe6f4a063fe1500ee0', token='1000.ec0571ede108b1445d37c52fe37ae396.39761c498ba22990e74baf854da7345f', token_type=TokenType.GRANT, redirect_url='https://app.getpostman.com/oauth2/callback')

        """
        Create an instance of TokenStore
        1 -> Absolute file path of the file to persist tokens
        """
        store = FileStore(file_path='./token.txt')
        ...
        """
#         store = DBStore()
#         store = DBStore(host='host_name', database_name='zohooauth', user_name='user_name', password='password',port_number='port_number')
